...
function charCreate() {
    if (PageAttributes.characterPage === 'complete') {
        $('#ccCard').css('background-image', 'url(./images/player2done.jpg)');
...
function statCreate() {
    if (PageAttributes.statsPage == 'complete') {
        $('#statCard').css('background-image', 'url(./images/stats2done.jpg)');
...
function equipCreate() {
    if (PageAttributes.equipPage == 'complete') {
        $('#equipCard').css('background-image', 'url(./images/equip2done.jpg)');
...
function spellCreate() {
    if (PageAttributes.spellPage == 'complete') {
        $('#spellCard').css('background-image', 'url(./images/spells2done.jpg)');
