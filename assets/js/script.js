...
function charCreate() {
    if (PageAttributes.characterPage === 'complete') {
        $('#ccCard').css('background-image', 'url(/DDCharacterCreation/assets/images/player2done.jpg)');
...
function statCreate() {
    if (PageAttributes.statsPage == 'complete') {
        $('#statCard').css('background-image', 'url(/DDCharacterCreation/assets/images/stats2Done.jpg)');
...
function equipCreate() {
    if (PageAttributes.equipPage == 'complete') {
        $('#equipCard').css('background-image', 'url(/DDCharacterCreation/assets/images/equip2done.jpg)');
...
function spellCreate() {
    if (PageAttributes.spellPage == 'complete') {
        $('#spellCard').css('background-image', 'url(/DDCharacterCreation/assets/images/spells2done.jpg)');
